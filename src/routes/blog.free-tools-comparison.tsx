...
const ROWS = [
  ...
  {
    name: "הכיתה שלי (חינמי במסלול הבסיסי)",
    pros: [
...
const FAQ: FaqItem[] = [
  {
    ...
    a: "כן. פנקס נייר, גיליון Excel/Google Sheets ו-״הכיתה שלי״ במסלול הבסיסי הם חינמיים לחלוטין. כלים כלליים כמו ClassDojo מציעים חשבון חינמי, אך לרוב מציגים פרסומות וממשק אנגלי שפחות מתאים לחיידר.",
  },
  {
    q: "האם הכלי מתאים לעברית ולכתב ימין-לשמאל?",
    a: "פנקס וגיליון מאפשרים לכתוב בעברית, אך אינם מותאמים RTL. הכיתה שלי בנוי מראש בעברית, עם כיוון ימין-לשמאל, גופני Heebo, ומקצועות קודש כברירת מחדל.",
  },
  {
    q: "מה לגבי פרטיות התלמידים?",
    a: "אפליקציות כלליות בינלאומיות שומרות נתונים בענן שלהן ולעתים משתמשות בדאטה למודלים. הכיתה שלי נבנה עם גישה של מינימום נתונים, שמות פנימיים בלבד, ואפשרות דפים ציבוריים אנונימיים להורים.",
  },
  {
  ...
  },
  {
    ...
    a: "מומלץ לשמור את הפנקס לרישום מיידי במהלך השיעור, ולהעביר סיכומים יומיים ל-״הכיתה שלי״ ב-5 דקות בסוף היום. כך לא מאבדים את הרגלי הכיתה הקיימים ומקבלים גיבוי דיגיטלי.",
  },
  {
    q: "לאיזה כלי כדאי להתחיל אם יש לי כיתה אחת קטנה?",
    a: "לכיתה קטנה של עד 12 תלמידים, פנקס נייר או גיליון פשוטים יספיקו בהתחלה. ברגע שהכיתה גדלה או שרוצים הגרלות, קבוצות, דו״חות להורים ומעקב התנהגות — הכיתה שלי חוסך זמן משמעותי.",
  },
];

export const Route = createFileRoute("/blog/free-tools-comparison")({
  component: Article,
  head: () => blogPostHead("/blog/free-tools-comparison", [faqJsonLd(FAQ)]),
});
