    ...
    <div dir="rtl" className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        <article className="prose prose-invert max-w-none [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-bold [&_h3]:mt-6 [&_h3]:text-xl [&_h3]:font-semibold [&_p]:mt-4 [&_p]:leading-relaxed [&_ul]:mt-4 [&_ul]:list-disc [&_ul]:pr-6 [&_li]:mt-2">
          ...
          <h2>שאלות שמלמדים שואלים אותנו</h2>
          <h3>זה לא יוצר תחושה של "אח גדול"?</h3>
          <p>
            כשמסבירים לתלמידים שזה בא לסייע לרב לדעת שכולם במקום בטוח — הם מקבלים זאת
            בטבעיות. זה לא שונה מהותית מרשימת נוכחות, רק יותר עדכני.
          </p>
          <h3>מה אם אין אינטרנט בכיתה?</h3>
          <p>
            ClassAlign עובדת גם במצב מקומי ומסתנכרנת אחר כך. אין צורך באינטרנט יציב כל
            הזמן.
          </p>
          <h3>זה דורש זמן ללימוד?</h3>
          <p>
            לא. הממשק בעברית, הלחיצה אחת, וההטמעה לרב לוקחת פחות מעשר דקות.
          </p>
