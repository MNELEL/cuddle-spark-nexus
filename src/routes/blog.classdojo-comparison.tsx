...
const FAQ: FaqItem[] = [
  ...
  {
    q: "מה ההבדל המרכזי בין הכיתה שלי ל-ClassDojo?",
  ...
  },
  {
    ...
    a: "הכיתה שלי עובד עם מינימום נתונים אישיים: שמות פנימיים בלבד, ללא תמונות תלמידים כברירת מחדל, ואין העברה אוטומטית לצדדים שלישיים. ClassDojo מפעיל שרתים בארה\"ב ומאפשר פיצ׳רים חברתיים שדורשים חשיפה נוספת.",
  },
  {
    q: "האם הכיתה שלי תומך בהערכה במקצועות קודש?",
    a: "כן. גמרא, משנה, חומש, נביא, הלכה, מוסר, תפילה ופרשת שבוע הם מקצועות ברירת מחדל במערכת. ניתן להוסיף מקצועות משלכם, וגם הבינה המלאכותית של הכיתה שלי יודעת לזהות אותם בסיכומי שיעור ובתעודות.",
  },
  {
    q: "מתי בכל זאת ClassDojo יכול להתאים?",
    a: "לבתי ספר חילוניים דוברי אנגלית שמעדיפים מודל חברתי־ציבורי עם הורים פעילים בפיד, ClassDojo יכול להיות מתאים. למוסדות חרדיים שמחפשים דו״ח פרטי, עברית מלאה ומונחי חיידר — הכיתה שלי יתאים יותר.",
  },
];
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        <article className="prose prose-invert max-w-none [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-bold [&_p]:mt-4 [&_p]:leading-relaxed">
          ...
          <p>
            ...
            הכיתה שלי בונה דו״ח: המלמד מסכם, מייצר PDF ממותג עם שם המוסד והלוגו, ושולח להורה
