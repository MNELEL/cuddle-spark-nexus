...
const DESCRIPTION =
  "מדריך מקצועי למלמדים ורבנים: איך להשתמש ב-AI Sort כדי לבנות סידורי ישיבה שמפחיתים הפרעות, משפרים ריכוז, ומנהלים כיתה גדולה בתלמוד תורה — במקום שעות עבודה ידנית.";

const FAQ: FaqItem[] = [
  {
    q: "מהו AI Sort ואיך הוא בונה סידור ישיבה?",
    a: "AI Sort הוא כלי ב-ClassAlign שמנתח את הרכב הכיתה — התנהגות, ריכוז, קשרים חברתיים והישגים במקצועות קודש — ובונה סידור ישיבה מיטבי בכמה שניות. הוא מפזר תלמידים מפריעים, מקרב תלמידים חלשים למובילים, ושומר על איזון קבוצתי.",
  },
  {
  ...
  },
  {
    ...
    a: "כן. ClassAlign לומדת מדפוסי התנהגות שנרשמו לאורך זמן, וכשמצב הכיתה משתנה — תלמיד חדש, שינוי בהתנהגות, קבוצת חברותא חדשה — AI Sort מציע התאמה מחודשת בלחיצה.",
  },
  {
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        <article className="prose prose-invert max-w-none [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-bold [&_p]:mt-4 [&_p]:leading-relaxed">
          ...
          <p className="mt-4 text-muted-foreground">
            ...
            לחלשים בגמרא? המדריך הזה מראה איך AI Sort ב-ClassAlign מטפל בכל זה תוך שניות — בלי לוותר
          ...
          <p>
            AI Sort ב-ClassAlign מנתח שלושה שכבות נתונים: (1) התנהגות יומית — מי הפריע, מי התרכז,
          ...
          <ol className="mt-4 list-decimal pr-6 space-y-2">
            <li>נכנסים לכיתה במסך <Link to="/" className="text-primary hover:underline">ClassAlign</Link> ופותחים את תצוגת ה-Grid.</li>
          ...
          <p>
            אחרי כל סידור, ClassAlign עוקבת אחרי אירועי ההפרעה בשבועיים הבאים ומשווה לתקופה שלפני
