              ...
              <Card key={g.id}>
                <CardContent className="flex items-center justify-between gap-2 py-3">
                  ...
                  <div className="flex flex-col gap-1">
                    <Button variant="ghost" size="icon" aria-label="ערוך יעד" onClick={() => { setEditing(g); setOpen(true); }}>
                      <Pencil className="h-4 w-4" />
                    </Button>
                    <Button variant="ghost" size="icon" className="text-destructive" aria-label="מחק יעד" onClick={() => removeM.mutate(g.id)}>
