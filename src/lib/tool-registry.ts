...
export const TOOLS: ToolEntry[] = [
  ...
  { to: "/class-anchors", section: "tools", requires: "classes", icon: "CalendarClock", label: "הכיתות שלי ותאריך-החלוף", desc: "תאריך-החלוף, היום והתאריך הבא לכל כיתה עם סיכום התיעוד היומי" },
